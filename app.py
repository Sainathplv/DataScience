...
classes = ['System predicted disease is BrownSpot',
           'System predicted disease is Healthy',
           'System predicted disease is LeafBlast',
           'System predicted disease is LeafBlight']
...
def upload():
    ...
    fn=myfile.filename
    mypath=os.path.join("C:/Users/sai palavala/OneDrive/Desktop/my proj/Rice leaf classification/images/", fn)
    myfile.save(mypath)
    ...
    new_model = load_model(r"C:\Users\sai palavala\OneDrive\Desktop\my proj\Rice leaf classification\ResNet50-2.h5")
...
def send_image(filename):
    return send_from_directory("C:/Users/sai palavala/OneDrive/Desktop/my proj/Rice leaf classification/images",filename)
@app.route('/upload1')
def upload1():
    print("Hello")
